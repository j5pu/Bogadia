...
function bogacontest_assets(){
    ...
    wp_register_script('images_loaded', '/wp-content/plugins/boga-contest/assets/js/imagesloaded.pkgd.min.js', array('jquery'));
    ...
    wp_register_script('bogacontest', '/wp-content/plugins/boga-contest/assets/js/bogacontest.js', array('jquery', 'typewatch', 'load_img', 'velocity', 'velocityui', 'masonry', 'images_loaded'));
