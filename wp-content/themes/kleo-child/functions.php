    ...
    function kleo_entry_meta( $echo = true, $att = array() ) {
		...
		if (!wp_is_mobile()){
			if(is_single() && !is_single(35229)){
				array_push($meta_list, '<button id="share_submit_post" class="share_submit" onclick="myFacebookLogin()">Haz click para compartir y ganar 50 € (60 US$)</button>');
			}
		}
        if ( $echo ) {
...
/*function send_smtp_email( $phpmailer ) {
	...
	$phpmailer->Username = "valle@bogadia.com";

	// Password to use for SMTP authentication
	$phpmailer->Password = "1aragon1";

	// Encryption system to use - ssl or tls
	$phpmailer->SMTPSecure = "tls";

	$phpmailer->From = "you@bogadia.com";
	$phpmailer->FromName = "Bogadia";
}*/
function send_smtp_email( $phpmailer ) {
	...
	// The hostname of the mail server
	$phpmailer->Host = "ssrs.reachmail.net";
	...
	$phpmailer->From = "bogadia@bogadia.com";
	$phpmailer->FromName = "Bogadia";
}